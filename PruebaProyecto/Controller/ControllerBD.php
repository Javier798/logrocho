...
{    
    ...
    public function anadirLikes($idReseña)
    {
        $gestor = new bd(Conexion::getConexion(host, bdname, user, password));
        $gestor->añadirLike($idReseña);
    }
    /**
     * bajaPincho
     * borra pincho
    ...
    /**
     * modificarRsena modifica la reseña
     *
     * @param  mixed $mensaje
     * @param  mixed $valoracion
     * @param  mixed $id
    ...
    function modificarRsena($mensaje, $valoracion,$id)
    {
        ...
        if(!empty($arrayFiltros)){
            $arrayFiltros[" where Cod_reseña="]=$id;
        }
     ...
     * añade un like
     *
     * @param  mixed $fkReseñas
     * @param  mixed $fkusuario
     * @return void
     */
    function añadirLike($fkReseñas, $fkusuario)
    {
    ...
    public function guardarImagenBar($id,$imagen)
    {
        ...
        $gestor = new bd(Conexion::getConexion(host, bdname, user, password));
        $gestor->añadeImagenBar($arrayFiltros);
    }
    ...
    public function guardarImagenUsuario($id,$imagen)
    {
        ...
        $gestor = new bd(Conexion::getConexion(host, bdname, user, password));
        $gestor->añadeImagenUsuario($arrayFiltros);
    }
    ...
    public function guardarImagenPincho($id,$imagen)
    {
        ...
        $gestor = new bd(Conexion::getConexion(host, bdname, user, password));
        $gestor->añadeImagenPincho($arrayFiltros);
    }    
    /**
     * borrarImagenPincho
     *
