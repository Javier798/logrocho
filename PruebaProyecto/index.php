...
if (isset($array_ruta[0]) && $array_ruta[0] == "login") {
    ...
    $controllerBD->altaUsuarios($_POST["nombre"], $_POST["email"], $_POST["apellido"], $_POST["contrasenia"], $_POST["rol"]);
} else if (isset($array_ruta[0]) && $array_ruta[0] == "altaUsuarioFront") {
    $controllerBD->altaUsuarios($_POST["usuario"], $_POST["email"], $_POST["apellido"], $_POST["contrasenia"], $_POST["rol"]);
    ...
    $controllerBD->modificarUsuarios($_POST["nombre"], $_POST["email"], $_POST["apellido"], $_POST["contrasenia"], $_POST["rol"], $_POST["id"]);
} else if (isset($array_ruta[0]) && $array_ruta[0] == "getResenaDetalle") {

    $id = $_POST["id"];
    $codUsu = $_POST["codUsu"];
    $controllerApi->getReseniasDetalle($id, $codUsu);
} else if (isset($array_ruta[0]) && $array_ruta[0] == "getResenas") {
    $controllerApi->getResenias();
} else if (isset($array_ruta[0]) && $array_ruta[0] == "getResenasLimit") {
    $ordenacion = $_POST["ordenacion"];
    $indice = $_POST["indice"];
    $cantidad = $_POST["cantidad"];
    $controllerApi->getReseniasLimit($ordenacion, $indice, $cantidad);
} else if (isset($array_ruta[0]) && $array_ruta[0] == "altaResena") {
    $controllerBD->altaResena($_POST["mensaje"], $_POST["valoracion"], $_POST["Fk_pincho"], $_SESSION["codigo_usuaraio"]);
    ...
    $controllerSession->comprobarSession($array_ruta[0]);
    $controllerSession->mostrarInfoResenia($array_ruta[0]);
    ...
    $cantidad = $_POST["cantidad"];
    $id = $_POST["id"];
    $controllerApi->getReseniasPorPinchoLimit($ordenacion, $indice, $cantidad, $id);
    ...
    $controllerSession->comprobarSession($array_ruta[0]);
    $controllerSession->mostraraniadirUsuario($array_ruta[0]);
    ...
    $controllerSession->comprobarSession($array_ruta[0]);
    $controllerSession->mostraraniadirPincho($array_ruta[0]);
    ...
    $controllerSession->comprobarSessionFront($array_ruta[0]);
    $id = $_POST["id"];
    $controllerApi->getReseniasPorPincho($id);
