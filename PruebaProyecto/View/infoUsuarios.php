...
<body>
    ...
    <div id="parteSuperior">
        <div id="galeria">
            ...
            <div id="botones">
                ...
                <a class="btn btn-warning" href="#" onclick="eliminarLikes()">Borrar likes</a>
            </div>
        </div>
        <div id="informacion">
            <div id="titulo">
                <div>
                    <h5>Nombre</h5>
                    <input onkeypress="esLetra(event)" id="nombreUsuario" type="text" placeholder="Champiñones">
            ...
            <div id="credenciales">
                ...
                <div id="password">
                    <h5>Contraseña</h5>
                    <input type="password" id="contraseñaUsuario" placeholder="****">
                </div>
            </div>
            <div id="rol">
                <h5>Rol:</h5>
                <select name="" id="rolUsuario">
                    <option value="Bar Achuri">Admin</option>
                    <option value="Torres Laurel">Editor</option>
                    <option value="JUAN Y PINCHAME">Usuario</option>
                </select>
            </div>
            <div>
    ...
    <script src="../View/js/infoUsuarios.js"></script>
</body>
