...
<body>
    ...
    <div id="parteSuperior">
        <div id="galeria">
            ...
            <div id="botones">
                <a class="btn btn-primary" onclick="guardarBar()" href="#">Guardar</a>
        ...
        <div id="informacion">
            <div id="arriba">
                ...
                <div id="puntuacion">
                    <h5>Direccion</h5>
                    <input type="text" placeholder="Calle del Laurel, 26001 Logroño, La Rioja" name="" id="direccionBar">
                </div>
            </div>
    ...
    <script src="../View/js/añadirBares.js"></script>
</body>
