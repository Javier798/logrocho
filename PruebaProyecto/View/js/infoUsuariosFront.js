...
function enviarDatos() {
    ...
    $.ajax({
        ...
        data: { nombre: nombre, apellido: apellido, email: email, contraseña: "", rol: "", id: id },
...
function mostrarDatos() {
    ...
    if (numFilas == "") {
        ...
        $.ajax({
            ...
            success: function (json) {
                resultados = eval(json);
                var reseñas = document.querySelector('#agrupacionReseñas');
...
function construirFila(datos, n, url) {
    ...
    infoResena.className = "infoReseña";

    var imagen = document.createElement('img');
    imagen.className = "imgReseña";
    if (datos.ruta != null) {
    ...
    if (url == "getResenasPorUsuarioLimit") {
        ...
        if (datos.likesUsuario > 0) {
            like.children[0].style.color = "blue";
        }
    }
...
function mostrarResenas(item) {
    ...
    numFilas = 0;
    mostrarDatos();
    item.style.borderBottom = "solid #007bff 1px";
...
function mostrarLikes(item) {
    ...
    item.style.borderBottom = "solid #007bff 1px";
    item.style.color = "#007bff";
    document.getElementById("tituloReseñas").style.borderBottom = "solid black 1px";
    document.getElementById("tituloReseñas").style.color = "black";
}
