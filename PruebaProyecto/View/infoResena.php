...
<head>
    ...
    <link rel="stylesheet" href="../View/styles/infoReseña.css">
    ...
    <div id="parteSuperior">
        ...
        <div id="informacion">
            <div id="titulo">
                <div>
                    <h5>Nombre</h5>
                    <input disabled id="resenaNombre" type="text" placeholder="Champiñones">
                </div>
                <div>
                    <h5>Pincho</h5>
                    <input disabled type="text" id="resenaPincho" name="" placeholder="Champiñones">
                </div>
            </div>
            <div id="descripcion">
