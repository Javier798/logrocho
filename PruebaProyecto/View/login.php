            ...
            <div class="card-body">
                <div class="card-body">
                    ...
                    <form id="loginForm" method="POST" action="<?php echo $accion; ?>" class="">
                        ...
                        <div class="form-floating mb-3"><input placeholder="Contraseña" type="password" name="contrasena" id="password" class="form-control"><label class="form-label" for="password">Contraseña</label></div>
                        <div>
