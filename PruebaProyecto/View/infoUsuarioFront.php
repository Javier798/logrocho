...
<body>
    ...
    <div id="parteSuperior">
        ...
        <div id="informacion">
            ...
            <div id="cambioContraseña">
                <button onclick="cambiarContraserna()" class="btn btn-primary">Cambiar contraseña</button>
            </div>
            <div id="borrarCuenta">
    ...
    <div id="parteInferior">
        <div id="reseñas">
            <div id="titulos">
                <h4 id="tituloReseñas" onclick="mostrarResenas(this)">Reseñas</h4>
                <h4 id="tituloLikes" onclick="mostrarLikes(this)">Likes</h4>
            </div>
            <div id="agrupacionReseñas">
