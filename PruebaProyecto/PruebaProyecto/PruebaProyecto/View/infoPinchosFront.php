...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="publicar" data-dismiss="modal" type="button" onclick="aniadirResenias()" class="btn btn-primary">Publicar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="tituloPinchos">
        <h1>Pinchos</h1>
        <button class="btn btn-success" id="anadirResenia" data-toggle="modal" data-target="#exampleModalCenter">Añadir reseña</button>
    </div>
    <div id="bares">
    </div>
