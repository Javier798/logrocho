...
<head>
    ...
    <link rel="stylesheet" href="../View/styles/listadoResenias.css">
    <title>Bares</title>
</head>
...
<body onload="mostrarDatos()">
    ...
    <div id="contenedor">
        <div id="titulo">
            <h2>Listado de resenias</h2>
        </div>
        <div id="filtros">
            <div id="filtrosFiltrar">
            <div id="filtradoNota">
                <label class="margenFiltro" for="desde"><b>Valoracion</b> desde:</label>
                <input type="number" class="rango form-control" name="desde" id="desde">
                <label class="margenFiltro" for="hasta">Hasta:</label>
                <input type="number" class="rango form-control" name="hasta" id="hasta">
            </div>
    ...
    <script src="../View/js/paginacionResenias.js"></script>
