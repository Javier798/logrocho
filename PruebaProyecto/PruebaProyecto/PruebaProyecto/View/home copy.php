...
<body>
    ...
    <section>
        <h1 class="titulo">Resenias populares</h1>
        <div id="reseniasPopulares">
            <div class="resenia">
                <div class="contenido">
                    <div class="parteIzquierda">
                        <img class="imgResenia" src="../View/img/perfildeusuario.jpg" alt="">
                        <h6>Usuario</h6>
                        <hr>
                        <p onclick="verResenia()">Lorem fistrum fistro ese que llega sexuarl benemeritaar por la gloria de mi madre.</p>
                    </div>
                    <div class="infoResenia">
