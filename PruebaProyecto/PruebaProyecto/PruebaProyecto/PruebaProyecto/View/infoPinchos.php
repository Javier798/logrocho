...
<body>
    ...
    <div id="parteSuperior">
        ...
        <div id="informacion">
            ...
            <div id="titulo">
                <h5>Nombre</h5>
                <input id="nombrePincho" type="text" placeholder="Champiniones">
            </div>
            <div id="puntuacion">
                <h5>Puntuacion</h5>
                <input onkeypress="esNumero(event)" id="puntuacionPincho" type="number" placeholder="2">
            </div>    
            </div>
    ...
    <script src="../View/js/infoPinchos.js"></script>
