...
var sentencia = "";
var ordenar = "";
var cmapos = { Cod_usuario: "", Nombre: "", Apellido: "", Email: "", Contrasenia: "", Rol: "" };
var itemsMowstrados = [];
var departamentos;
var claveOrdenacion;
...
function construirCabecera() {
    ...
    var titulo = document.createElement('th');
    var contenedor = document.createElement('p');
    var texto = document.createTextNode("Contrasenia");
    titulo.id = "Contrasenia";
    titulo.scope = "col";
    contenedor.appendChild(texto);
    contenedor.innerHTML += "<i class='fa fa-sort' aria-hidden='true'></i>";
    titulo.appendChild(contenedor);
