...
<head>
    ...
    <link rel="stylesheet" href="../View/styles/listadoPinchos.css">
...
<body onload="mostrarDatos()">
    ...
    <div id="contenedor">
        <div id="titulo">
            <h2>Listado de pinchos</h2>
        </div>
        <div id="filtros">
            <div id="filtrosFiltrar">
                <select onchange="mostrarDatos()" id="roles" class="form-select" aria-label="Default select example">
                    
                </select>
                <div id="filtradoNota">
                    <label class="margenFiltro" for="desde"><b>Nota</b> desde:</label>
                    <input onchange="mostrarDatos()" type="number" class="rango form-control" value="0" name="desde" id="desde">
                    <label class="margenFiltro" for="hasta">Hasta:</label>
                    <input onchange="mostrarDatos()" type="number" class="rango form-control" value="10" name="hasta" id="hasta">
                </div>
                <div id="buscador" class="input-group rounded">
                    <input onkeyup="mostrarDatos()" type="search" class="form-control rounded" id="search" placeholder="Buscar" aria-label="Search" aria-describedby="search-addon" />
                    <span class="input-group-text border-0 cursor" id="search-addon">
                        <i class="fa fa-search" aria-hidden="true"></i>
                    </span>
                </div>
            </div>
            <div id="aniadir">
                <button onclick="anadirPincho()" class="btn btn-success">Aniadir</button>
            </div>
        </div>
        <div id="tabla">
    ...
    <script src="../View/js/paginacionPinchos.js"></script>
