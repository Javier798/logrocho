...
<head>
    ...
    <link rel="stylesheet" href="../View/styles/bares.css">
...
<body onload="mostrarDatos()">
        ...
        <div id="filtros">
            <div id="filtrosFiltrar">
                ...
                <div id="buscador" class="input-group rounded">
                    <input onkeyup="mostrarDatos()" type="search" class="form-control rounded" placeholder="Buscar" id="search" aria-label="Search" aria-describedby="search-addon" />
            ...
            <div id="aniadir">
                <button onclick="anadirBar()" class="btn btn-success">Aniadir</button>
            </div>
        </div>
        <div id="tabla">
    ...
    <script src="../View/js/paginacionBares.js"></script>
