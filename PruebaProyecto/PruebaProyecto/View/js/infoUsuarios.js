...
window.onload = () => {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            document.getElementById("contraseniaUsuario").value = resultados[0].Contrasena;
...
function enviarDatos() {
    ...
    let contrasena = document.getElementById("contraseniaUsuario").value;
...
function construirCabecera() {
    ...
    var texto = document.createTextNode("Cod Resenia");

    titulo.appendChild(texto);
    titulo.scope = "col";
    titulo.id = "Cod_resenia";
    titulo.className = "col1";
    titulo.addEventListener("click", () => {
        ordenacion(document.getElementById("Cod_resenia"));
