	...
	<div class="bg-contact100" >
		<div id="fondo" class="container-contact100">
			<div class="wrap-contact100">
				...
				<form id="altaUsuario" method="POST" action="altaUsuarioFront" class="contact100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
						...
						<input class="input100" type="text" name="usuario" placeholder="Pepe">
					...
					<div class="wrap-input100 validate-input" data-validate="Apellido is required">
						<input class="input100" type="text" name="apellido" placeholder="Garcia">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
						<i class="fa fa-user" aria-hidden="true"></i>
						</span>
					</div>
					<input class="input100" type="hidden" name="rol" placeholder="nombre">
					<label for="">Contrasenia</label>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="contrasenia" placeholder="nombre">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
